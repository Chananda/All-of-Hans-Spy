...
if( window == top ){
        ...
        similarproducts.b.wlVersion="14.10.30.1";
        similarproducts.b.wlOldVersion="14.08.31.1";
        similarproducts.b.wlDestDate="2014.11.02";
        similarproducts.b.wlStartDate="2014.10.30";
...
similarproducts.b.isDistributorBl=0;
            ...
            similarproducts.inimg = (function()
{
	var inimg =
	{
		...
		initialize: function(items, targetImage)
		{
			...
			{
				similarproducts.slider.initialize(this.items, 15);
